...
import {UsersActionsTypes, UsersUpdateErrorAction, UsersUpdateRequestAction, UsersUpdateSuccessAction} from '../actions/user.actions';
...
export class TodosEffects {
  ...
  protected updateU$ = createEffect(() => this.actions$.pipe(
